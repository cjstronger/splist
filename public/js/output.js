...
if (chatBot) {
  ...
  chatBot.addEventListener("submit", /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(e) {
      var _yield$spotify$spotif, data, err;
        ...
        while (1) switch (_context3.prev = _context3.next) {
          ...
          case 9:
            data.data.data.forEach(function (item) {
              var html = "<div class=\"song\"><h1 class=\"song-name\">".concat(item.name, "</h1><p class=\"album-name\">").concat(item.album.name, "</p><p class=\"artist-name\">").concat(item.artists[0].name, "</p><img src=\"").concat(item.album.images[1].url, "\"/></div>");
...
},{"./login":"login.js","./spotify":"spotify.js","./toast":"toast.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
